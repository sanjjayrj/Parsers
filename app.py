...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nLabel.setGeometry(QtCore.QRect(50, 170, 221, 16))
        self.nLabel.setObjectName("nLabel")
        self.nSpin = QtWidgets.QSpinBox(self.centralwidget)
        self.nSpin.setGeometry(QtCore.QRect(260, 170, 42, 22))
        ...
        self.LL_0.setGeometry(QtCore.QRect(40, 440, 221, 71))
        self.LL_0.setObjectName("LL_0")
        self.LL_1 = QtWidgets.QPushButton(self.centralwidget)
        self.LL_1.setGeometry(QtCore.QRect(420, 440, 221, 71))
        self.LL_1.setObjectName("LL_1")
        self.SLR = QtWidgets.QPushButton(self.centralwidget)
        self.SLR.setGeometry(QtCore.QRect(770, 440, 221, 71))
        self.SLR.setObjectName("SLR")
        self.clearButton = QtWidgets.QPushButton(self.centralwidget)
        self.clearButton.setGeometry(QtCore.QRect(870, 600, 93, 28))
        self.clearButton.setStyleSheet("background-color: rgb(239, 88, 88);")
        self.clearButton.setObjectName("clearButton")
        self.Querry = QtWidgets.QLabel(self.centralwidget)
        self.Querry.setGeometry(QtCore.QRect(470, 310, 111, 20))
        self.Querry.setObjectName("Querry")
        self.StartSymbol_2 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.StartSymbol_2.setGeometry(QtCore.QRect(300, 340, 421, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LL_0.setText(_translate("MainWindow", "LR"))
        self.LL_1.setText(_translate("MainWindow", "LL(1)"))
        self.SLR.setText(_translate("MainWindow", "SLR(1)"))
        self.clearButton.setText(_translate("MainWindow", "Clear Input"))
        self.Querry.setText(_translate("MainWindow", "Enter Querry"))
